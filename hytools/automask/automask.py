...
def locate_band(hyObj, lower_wavelength, upper_wavelength=None):
  ...
  waveunits = hyObj.wavelength_units.lower()#.decode('utf-8')
  good_band_list = hyObj.bad_bands
  #print(good_band_list)
  ...
  if waveunits[:4]=='nano':
    ...
    unit_scale=1e-3
  #print(upper_wavelength, lower_wavelength)
  if   upper_wavelength is None:
    ...
    range_list=unit_scale*range_list
    #print((file_wavelist>range_list[0])*(file_wavelist<range_list[1])*(good_band_list>0))
...
def hi_lo_msk(hyObj, hi_thres=0.8, lo_thres = 0.3):
    ...
    waveunits = hyObj.wavelength_units
    #print(wavelist)
    #print(waveunits)
