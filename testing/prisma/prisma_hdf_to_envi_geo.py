...
# UNDER DEVELOPMENT!!!!
# This script projected and exports a PRISMA HDF file ENVI file
# Georeferencing is based upon lat and lon from geolocation tables
# Map/projection info is image specific
...
output_file=  "%s/Desktop/vnir_swir_geo" % home
